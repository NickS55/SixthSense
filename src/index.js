...
var height = 500;
var plane_geometry = new THREE.PlaneGeometry(100, height);
var plane_material = new THREE.MeshBasicMaterial({ color: 0x567d46, side: THREE.DoubleSide });
...
function create_line(spinAngle, rpm, x, y, z, velX, velY, velZ, plate_x, plate_z) {
